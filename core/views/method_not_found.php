...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?=app_url('core/views/css/style.css')?>" />
...
<div id="notfound">
    <div class="notfound">
        ...
        <h2 class="error_args">Oops! <strong>Method</strong>  was not found in </h2><h3>Error in :<?=$name?></h3>
